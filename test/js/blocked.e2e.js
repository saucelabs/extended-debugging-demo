...
describe('my demo app', () => {
    describe('loads app with third party script', () => {
        it('should load fast', () => {
            browser.url('https://saucecon.com')
        ...
        //     }
        //
        //     const a = browser.log('sauce:timing')
        //     console.log('--->', a.value.performanceTiming.loadEventEnd - a.value.performanceTiming.navigationStart)
        })
    })
})
